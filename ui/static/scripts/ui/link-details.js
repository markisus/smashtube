...
(function() {
  require(['../main'], function(main) {
    return require(['domReady', 'jquery', 'typeahead', 'ractive', 'text!ui/set-list.template', 'ui/autocompletes/tournament'], function(ready, $, t, R, template, gtauto) {
      var sets_related_to_video;
      $(document).on('ready', '.select-character', function() {
        return alert('alert select character!');
      });
      $.ajaxSetup({
        data: {
      ...
      return sets_related_to_video(video_url_id, function(data) {
        ...
        sets = data.objects;
        R.transitions.player_select = function(el, complete) {
        ...
        R.transitions.character_select = function(el, complete) {
          $.ajax;
          console.log($(el).typeahead({
            prefetch: {
        ...
        window.r = new R({
          ...
          data: {
            ...
            attach_typeaheads: function(match_index) {
